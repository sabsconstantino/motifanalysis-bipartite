...
df_a = pd.read_csv('subgraphdata_videogames.csv')
df_a = df_a[df_a.years != '1997-2014']
df_a = df_a.drop(['years','K','num_U','num_O','avg_kO','avg_kU','subgraph_0','subgraph_1'],axis=1)
S = df_a.as_matrix() # rows: years, cols: subgraphs

df_k00 = pd.read_csv('random_counts/samek_vg9700.csv')
df_k00 = df_k00.drop(['# subgraph_0','subgraph_1'],axis=1)
df_k03 = pd.read_csv('random_counts/samek_vg9703.csv')
df_k03 = df_k03.drop(['# subgraph_0','subgraph_1'],axis=1)
df_k06 = pd.read_csv('random_counts/samek_vg9706.csv')
df_k06 = df_k06.drop(['# subgraph_0','subgraph_1'],axis=1)
df_k09 = pd.read_csv('random_counts/samek_vg9709.csv')
df_k09 = df_k09.drop(['# subgraph_0','subgraph_1'],axis=1)
df_k12 = pd.read_csv('random_counts/samek_vg9712.csv')
df_k12 = df_k12.drop(['# subgraph_0','subgraph_1'],axis=1)
df_k14 = pd.read_csv('random_counts/samek_vg9714x.csv')
...
plt.setp(axes, xticks=[y+1 for y in range(7)],
         xticklabels=['vg_00', 'vg_03', 'vg_06', 'vg_09', 'vg_12', 'vg_14'])

plt.savefig('plots/zscores_vg_samek.png')
#plt.show()