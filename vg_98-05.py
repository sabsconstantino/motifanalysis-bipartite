...
print motifs 
#[  3.27945000e+05   5.32961400e+06   2.23673396e+10   5.21265964e+10
#   1.31496000e+05   2.50965990e+07]
...
plt.xlabel("k")
plt.ylabel("P(k)")
plt.savefig('plots/pk_vg98-05_u.png')
...
plt.xlabel("k")
plt.ylabel("P(k)")
plt.savefig('plots/pk_vg98-05_o.png')

# power law fitting

print K # 108631
print len(nodes_U) # 68359
print len(nodes_O) # 9791
print avg_kU # 1.58912506034
print avg_kO # 11.0949851905