...
plt.xlabel("k")
plt.ylabel("P(k)")
plt.savefig('plots/pk_vg98-02_u.png')
...
plt.xlabel("k")
plt.ylabel("P(k)")
plt.savefig('plots/pk_vg98-02_o.png')

# power law fitting

print K # 49669
print len(nodes_U) # 33359
print len(nodes_O) # 5317
print avg_kU # 1.48892352888
print avg_kO # 9.34154598458